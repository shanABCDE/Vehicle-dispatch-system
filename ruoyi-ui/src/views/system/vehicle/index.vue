  ...
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="车牌" prop="licencePlate">
        <el-input
          v-model="queryParams.licencePlate"
          placeholder="请输入车牌"
          clearable
    ...
    <el-table v-loading="loading" :data="vehicleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="车牌" align="center" prop="licencePlate" />
      <el-table-column label="车型" align="center" prop="motorcycleType" />
      <el-table-column label="年限" align="center" prop="ageLimit" />
      <el-table-column label="状态" align="center" prop="state" >
        <template slot-scope="scope">
              <span>{{scope.row.state == 0 ? '未调用' : '已调用'}} </span>
            </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="车牌" prop="licencePlate">
          <el-input v-model="form.licencePlate" placeholder="请输入车牌" />
        </el-form-item>
             <el-form-item label="车型" prop="motorcycleType">
          <el-input v-model="form.motorcycleType" placeholder="请输入车牌" />
        </el-form-item>
        <el-form-item label="年限" prop="ageLimit">
          <el-input v-model="form.ageLimit" placeholder="请输入年限" />
        </el-form-item>
      </el-form>
