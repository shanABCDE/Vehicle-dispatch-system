<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="客户" prop="clienteleId">
        <el-input
          v-model="queryParams.clienteleId"
          placeholder="请输入客户"
          clearable
      ...
      <el-form-item label="出发地址" prop="depart">
        <el-input
      ...
      <el-form-item label="到达地址" prop="arrive">
        <el-input
          v-model="queryParams.arrive"
          placeholder="请输入到达地址"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="交易金额" prop="sum">
        <el-input
    ...
    <el-table v-loading="loading" :data="formList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="客户" align="center" prop="clienteleId" />
      <el-table-column label="交易内容" align="center" prop="content" />
      <el-table-column label="驾驶员" align="center" prop="driverId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="客户" prop="clienteleId">
          <el-input v-model="form.clienteleId" placeholder="请输入客户" />
        </el-form-item>
        <el-form-item label="交易内容">
          <editor v-model="form.content" :min-height="192"/>
        </el-form-item>
        <el-form-item label="驾驶员" prop="driverId">
          <el-input v-model="form.driverId" placeholder="请输入驾驶员" />
        </el-form-item>
        <el-form-item label="车辆" prop="vehicleId">
          <el-input v-model="form.vehicleId" placeholder="请输入车辆" />
        </el-form-item>
        <el-form-item label="出发地址" prop="depart">
          <el-input v-model="form.depart" placeholder="请输入出发地址" />
        </el-form-item>
        <el-form-item label="到达地址" prop="arrive">
          <el-input v-model="form.arrive" placeholder="请输入到达地址" />
        </el-form-item>
        <el-form-item label="交易金额" prop="sum">
          <el-input v-model="form.sum" placeholder="请输入交易金额" />
        </el-form-item>
        <el-form-item label="状态" prop="state">
