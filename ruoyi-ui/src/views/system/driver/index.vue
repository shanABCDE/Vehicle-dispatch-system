<template>
 ...
 <el-form-item label="驾龄" prop="drivingYears">
        <el-input
          v-model="queryParams.drivingYears"
          placeholder="请输入驾龄"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="driverList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="驾驶员" align="center" prop="name" />
      <el-table-column label="年龄" align="center" prop="annum" />
      <el-table-column label="状态" align="center" prop="state" >
           ...
           <template slot-scope="scope">
             ...
             <!-- scope.row 接收这一行数据 -->
              <span>{{scope.row.state == 0 ? '未出车' : '已出车'}} </span>
            </template>

      </el-table-column>

      <el-table-column label="联系方式" align="center" prop="relation" />
      <el-table-column label="驾龄" align="center" prop="drivingYears" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="驾驶员" prop="name">
          <el-input v-model="form.name" placeholder="请输入驾驶员" />
        </el-form-item>

        <el-form-item label="年龄" prop="annum">
          <el-input v-model="form.annum" placeholder="请输入年龄" />
        </el-form-item>
        ...
        <el-form-item label="驾龄" prop="drivingYears">
          <el-input v-model="form.drivingYears" placeholder="请输入驾龄" />
        </el-form-item>
      </el-form>
